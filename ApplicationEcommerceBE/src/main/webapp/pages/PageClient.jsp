...
<body>
    ...
    <div class="container">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link" href="#produit">Produits</a>
                            <a class="nav-item nav-link" href="/gestionClient/AfficherPanier">Panier</a>
      ...
      <c:forEach items= "${liste}" var="p">
          ...
          <form methode="POST" action="${pageContext.request.contextPath}/gestionClient/AddProduitPanier">
            <table>
              <tr>
                <td>
                  <img src=${pageContext.request.contextPath}/${p.img} style="height: 50px; width:100px;" alt=${p.libProduit} class="rounded-circle" data-holder-rendered="true">
                </td>
                <td>${p.libProduit}</td>
                <td>${p.quantite}</td>
                <td><input type="hidden" name="produit" value="${p.idProduit}"></td>
              </tr>
              <tr>
                <td><input type="numbre" name="quantite" value="1" min="1" max="${p.quantite}" placeholder="Quantite"></td>
