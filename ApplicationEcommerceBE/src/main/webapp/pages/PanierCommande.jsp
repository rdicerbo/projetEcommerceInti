...
<c:forEach items= "${lignepanier}" var="lp">
	...
	<td>${lp.quantite}</td>
	<td>
		<form methode="POST" action="${pageContext.request.contextPath}/gestionClient/ModifierProduitPanier">
			<table>
...
<a class="link" href="${pageContext.request.contextPath}/gestionClient/pageClient">Continuer achats</a>
<a class="link" href="${pageContext.request.contextPath}/gestionClient/commande">Passer commande</a>
